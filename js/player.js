class VideoPlayer {
    ...
    _skip(e) {
        this._video.currentTime += parseFloat(e.target.dataset.skip);
    }
    ...
    _playbackRangesHandler() {
        this._video.playbackRate = this._playbackRanges.value;
    }

    _skipHandlerOnVideoClick(e) {
    ...
    _setElements() {
        ...
        this._playbackRanges =  this._videoContainer.querySelector('input[name="playbackRate"]');
        //hw14 end
    }
    ...
    _setEvents() {
        ...
        //hw14 start
        this._skipBtns.forEach(btn => btn.addEventListener('click', e => this._skip(e)));
        this._volume.addEventListener('mousemove', () => this._volumeAdjustment());
        this._playbackRanges.addEventListener('click', () => this._playbackRangesHandler());
        this._video.addEventListener('dblclick', (e) => this._skipHandlerOnVideoClick(e));
    ...
    _createVideoTemplate() {
        ...
        <div class="player">
            ...
            <div class="player__controls">
              ...
              <input type="range" name="playbackRate" class="player__slider" min="0.5" max="2" step="0.1" value="${this._settings.playbackRanges}">
